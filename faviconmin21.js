...
function onSearchResultItemClick(a_ele) {
  var me = $(a_ele);
  var teamDriveId = a_ele.getAttribute("driveId")
    if (teamDriveId == window.drive_ids[0]) {
        ...
        var searchhost = "/29";
    } else if (teamDriveId == window.drive_ids[30]) {
        var searchhost = "/30";
    } else if (teamDriveId == window.drive_ids[31]) {
        var searchhost = "/31";
    } else if (teamDriveId == window.drive_ids[32]) {
        var searchhost = "/32";
    } else if (teamDriveId == window.drive_ids[33]) {
        var searchhost = "/33";
    } else if (teamDriveId == window.drive_ids[34]) {
        var searchhost = "/34";
    } else if (teamDriveId == window.drive_ids[35]) {
        var searchhost = "/35";
    } else if (teamDriveId == window.drive_ids[36]) {
        var searchhost = "/36";
    } else if (teamDriveId == window.drive_ids[37]) {
        var searchhost = "/37";
    } else if (teamDriveId == window.drive_ids[38]) {
        var searchhost = "/38";
    } else if (teamDriveId == window.drive_ids[39]) {
        var searchhost = "/39";
    } else if (teamDriveId == window.drive_ids[40]) {
        var searchhost = "/40";
    } else if (teamDriveId == window.drive_ids[41]) {
        var searchhost = "/41";
    } else if (teamDriveId == window.drive_ids[42]) {
        var searchhost = "/42";
    } else if (teamDriveId == window.drive_ids[43]) {
        var searchhost = "/43";
    } else if (teamDriveId == window.drive_ids[44]) {
        var searchhost = "/44";
    } else if (teamDriveId == window.drive_ids[45]) {
        var searchhost = "/45";
    } else if (teamDriveId == window.drive_ids[46]) {
        var searchhost = "/46";
    } else if (teamDriveId == window.drive_ids[47]) {
        var searchhost = "/47";
    } else if (teamDriveId == window.drive_ids[48]) {
        var searchhost = "/48";
    } else if (teamDriveId == window.drive_ids[49]) {
        var searchhost = "/49";
    } else if (teamDriveId == window.drive_ids[50]) {
        var searchhost = "/50";
    } else if (teamDriveId == window.drive_ids[51]) {
        var searchhost = "/51";
    } else if (teamDriveId == window.drive_ids[52]) {
        var searchhost = "/52";
    } else if (teamDriveId == window.drive_ids[53]) {
        var searchhost = "/53";
    } else if (teamDriveId == window.drive_ids[54]) {
        var searchhost = "/54";
    } else if (teamDriveId == window.drive_ids[55]) {
        var searchhost = "/55";
    } else if (teamDriveId == window.drive_ids[56]) {
        var searchhost = "/56";
    } else if (teamDriveId == window.drive_ids[57]) {
        var searchhost = "/57";
    } else if (teamDriveId == window.drive_ids[58]) {
        var searchhost = "/58";
    } else if (teamDriveId == window.drive_ids[59]) {
        var searchhost = "/59";
    } else if (teamDriveId == window.drive_ids[60]) {
        var searchhost = "/60";
    } else if (teamDriveId == window.drive_ids[61]) {
        var searchhost = "/61";
    } else if (teamDriveId == window.drive_ids[62]) {
        var searchhost = "/62";
    } else if (teamDriveId == window.drive_ids[63]) {
        var searchhost = "/63";
    } else if (teamDriveId == window.drive_ids[64]) {
        var searchhost = "/64";
    } else if (teamDriveId == window.drive_ids[65]) {
        var searchhost = "/65";
    } else if (teamDriveId == window.drive_ids[66]) {
        var searchhost = "/66";
    } else if (teamDriveId == window.drive_ids[67]) {
        var searchhost = "/67";
    } else if (teamDriveId == window.drive_ids[68]) {
        var searchhost = "/68";
    } else if (teamDriveId == window.drive_ids[69]) {
        var searchhost = "/69";
    } else if (teamDriveId == window.drive_ids[70]) {
        var searchhost = "/70";
    } else if (teamDriveId == window.drive_ids[71]) {
        var searchhost = "/71";
    } else if (teamDriveId == window.drive_ids[72]) {
        var searchhost = "/72";
